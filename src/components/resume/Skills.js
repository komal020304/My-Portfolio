    ...
    >
      <div className="w-full lgl:w-1/4">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <h2 className="text-2xl md:text-2xl font-bold">Programming Skill</h2>
        </div>
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Complexity Analysis</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
              ...
              >
                <span className="absolute -top-5 right-0">60%</span>
              </motion.span>
            </span>
          </div>
        </div>
      ...
      <div className="w-full lgl:w-1/4">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <h2 className="text-2xl md:text-2xl font-bold">Development Skill</h2>
        </div>
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">CSS Frameworks</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Web Designing</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
      ...
      <div className="w-full lgl:w-1/4">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <h2 className="text-2xl md:text-2xl font-bold">Core Subjects</h2>
        </div>
        <div className="flex flex-col gap-6">
          <div className="overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Systems Design</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
      ...
      <div className="w-full lgl:w-1/4">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <h2 className="text-2xl md:text-2xl font-bold">Soft Skills</h2>
        </div>
        <div className="flex flex-col gap-6">
          <div className="overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Presentation</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
